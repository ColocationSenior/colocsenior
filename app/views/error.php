    ...
    <div class="g-pa-20">
        ...
        <div class="media">
            <div class=" justify-content-md-center">
                <h1 class="g-font-weight-500 g-font-size-24 g-color-black mb-0">Une erreur est survenue ! </h1>
            </div>
        </div>
            ...
            <div class="col-xl-3 col-md-6 g-mb-30 mt-xl-5">
                <div class="card g-brd-gray-light-v7 rounded">
                    <header !
                        ...
                        <h3 class="g-font-weight-900 g-font-size-20 g-color-black g-mb-15">  Cette page
                    n'existe pas . . .</h3>
                    </header>
                ...
                <div class="row justify-content-center">
                    <a href="/"><span
                            class="u-tags-v1 text-center g-width-200 g-brd-around g-bg-green g-color-white g-rounded-10 g-py-4 g-px-15"
                            style="height:108px;overflow:hidden;background:url('/assets/img/logo/colocsenior_solo.png') center center;background-size:cover;"></span></a>
