                                ...
                                <section
                                    ...
                                    <div class="media-body align-self-center g-hidden-md-down">
                                        <div class="media g-mb-12">
                                            ...
                                            <h3 class="col-4 d-flex align-self-center g-font-size-16 g-font-weight-400 mb-0"
                                                style="color: #222E44;">
                                            ...
                                            <h3 class="col-4 d-flex align-self-center g-font-size-16 g-font-weight-400 mb-0 ml-auto"
                                                style="color: #222E44; margin-left: 250px">
                                            ...
                                            <em id="date"
                                                class="col-2 d-flex align-self-center align-items-center g-font-style-normal g-color-gray-light-v1 mb-0 ml-auto"
                                                style="color: #222E44;">
