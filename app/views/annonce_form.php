            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="h-100 g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md">
                        <form class="js-validate" method="post" action="/annonce/post" novalidate="novalidate" enctype='multipart/form-data'>
                            <header>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group u-file-attach-v1 g-brd-gray-light-v2">
                                    ...
                                    <div class="input-group-btn">
                                        ...
                                        <input type="file" name="pic1"  required accept=".jpg, .jpeg, .png">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group u-file-attach-v1 g-brd-gray-light-v2">
                                    ...
                                    <div class="input-group-btn">
                                        <button class="btn btn-md h-100 u-btn-primary rounded-0" type="submit">Parcourir</button>
                                        <input type="file" name="pic2"  required accept=".jpg, .jpeg, .png">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group u-file-attach-v1 g-brd-gray-light-v2">
                                    ...
                                    <div class="input-group-btn">
                                        <button class="btn btn-md h-100 u-btn-primary rounded-0" type="submit">Parcourir</button>
                                        <input type="file" name="pic3"  required accept=".jpg, .jpeg, .png">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group u-file-attach-v1 g-brd-gray-light-v2">
                                    ...
                                    <div class="input-group-btn">
                                        <button class="btn btn-md h-100 u-btn-primary rounded-0" type="submit">Parcourir</button>
                                        <input type="file" name="pic4"  required accept=".jpg, .jpeg, .png">
                                    </div>
                                </div>
                            </div><br>
