<?php
$GLOBALS['view']['title'] = "Créer une organisation";
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="h-100 g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md">
                    <form class="js-validate" novalidate="novalidate" method="post" action="/organisation/post" name="articleForm" enctype='multipart/form-data'>
                        <header>
                            <h2 class="text-uppercase g-font-size-12 g-font-size-default--md g-color-black mb-0"><?=$GLOBALS['view']['title']?></h2>
                            <?php if(strlen($GLOBALS['view']['organisation']['error']) > 2){?>
                            <span><?=$GLOBALS['view']['organisation']['error']?></span>
                            <?php } ?>
                        </header>

                        <div class="form-group g-mb-30 g-mt-30">
                            <label class="g-mb-10" for="inputGroup-1_1">Nom de l'organisation</label>
                        ...
                        <div class="form-group g-mb-30 g-mt-30">
                            <label class="g-mb-10" for="inputGroup-1_1">Email de contact</label>
                        ...
                        <div class="form-group g-mb-30 g-mt-30">
                            ...
                            <div class="g-pos-rel">
                                ...
                                <select name="departement" required>
                                    <?php foreach ($GLOBALS['view']['departement'] as $departement){ ?>
                        ...
                        <div class="form-group">
                            <h4 class="h6 g-font-weight-400 g-color-black g-mb-20">logo de l'organisation</h4>
                            ...
                            <div class="input-group u-file-attach-v1 g-brd-gray-light-v2">
                                ...
                                <div class="input-group-btn">
                                    ...
                                    <input type="file" name="logo" required accept=".jpg, .jpeg, .png">
                                </div>
                            </div>
                        </div><br>

                        <div class="form-group">
                            <h4 class="h6 g-font-weight-400 g-color-black g-mb-20">Bio / Description</h4>
